...
def highlight_text(syntax, theme, source):
    ...
    for key, value in syntax.items():
        source = re.sub(r"({})".format(value), color_text(theme[key], r"\1"), source, flags=re.MULTILINE)
    print(source)
...
def get_args():
    ...
    Returns:
       arguments inputed
    '''
    parser = argparse.ArgumentParser(description='A highlighter that highlights given file')
    ...
    parser.add_argument('sourcefile', help='This is the source file to be colored')
...
if __name__ == '__main__':
    ...
    highlight_text(syntax, theme, sourcefile)
